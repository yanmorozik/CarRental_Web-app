...
<div id="centerLayer">
    ...
    <table>
        ...
        <th>userName</th>
        <th>CarName</th>
        <th style="display: none">CarId</th>
        </thead>
        <c:forEach items="${allUsers}" var="user">
                        <tr>
                            <td>${user.username}</td>
                            <td>
                                <c:forEach items="${user.cars}" var="car">${car.name}; </c:forEach>
                            </td>
                            <td>
                                <form action="${pageContext.request.contextPath}/anfragen" method="post">
                                    <input type="hidden" name="CarsId" value="${user.cars}"/>
                                    <input type="hidden" name="userName" value="${user.username}"/>
                                    <input type="hidden" name="action" value="accept"/>
                                    <button type="submit" class="shine-button" >accept</button>
<%--                                    <input type="hidden" name="action" value="reject"/>--%>
<%--                                    <button type="submit" class="shine-button" >reject</button>--%>
                                </form>
                            </td>
                        </tr>
                    </c:forEach>
    ...
    <%--                </td>--%>
    <%--                <td>--%>
    <%--                    <c:forEach items="${user.cars}" var="care">${care.car_id}; </c:forEach>--%>
    <%--                </td>--%>
    <%--                <td>--%>
    <%--                    <form action="${pageContext.request.contextPath}/anfragen" method="post">--%>
    <%--                        <input type="hidden" name="CarsId" value="${user.cars}"/>--%>
