    ...
    <style>
        * {
        ...
        #centerLayer {
            ...
            margin: 1px 2px 3px 900px; /* Отступ слева и справа */
            ...
            <table>
                ...
                <c:forEach items="${allCars}" var="car">
                    <tr>
                        <td>${car.name}</td>
                        <td>
                            <form action="${pageContext.request.contextPath}/ordercar" method="post">
                                <input type="hidden" name="carId" value="${car.car_id}"/>
                                <input type="hidden" name="action" value="order"/>
                                <button type="submit" class="shine-button">Order</button>
                            </form>
                        </td>
                    </tr>
                </c:forEach>
